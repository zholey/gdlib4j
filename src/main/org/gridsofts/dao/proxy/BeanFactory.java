 ...
 */
package org.gridsofts.dao.proxy;
...
import org.gridsofts.dao.MetaInfo;
...
import org.gridsofts.dao.exception.AnnotationException;
import org.gridsofts.dao.exception.DAOException;
import org.gridsofts.dao.itf.IDao;
...
public class BeanFactory {
	 ...
	 * @throws DAOException
	 */
	public static <T> T create(IDao dao, Class<T> t, Map<String, Object> nameValueMap)
			throws DAOException {
	 ...
	 */
	public static <T> T createProxyBean(IDao dao, Class<T> t, Map<String, Object> nameValueMap)
			throws AnnotationException {
	 ...
	 * @throws DAOException
	 */
	public static void loadOneToMany(IDao dao, Class<?> t, String[] primaryKeys, Field otmField,
	 ...
	 * @throws DAOException
	 */
	public static void loadManyToOne(IDao dao, Class<?> t, Field mtoField, Object proxy)
			throws DAOException {
	 ...
	 * @return
	 */
	private static <T> T fillBeanFields(IDao dao, MetaInfo metaInfo, T bean,
