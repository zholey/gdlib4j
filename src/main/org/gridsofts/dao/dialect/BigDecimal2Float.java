 ...
 */
package org.gridsofts.dao.dialect;
 ...
 * @author Lei
 */
public class BigDecimal2Float implements ITypeConverter {
	...
	public boolean accept(Object value, Class<?> targetCls) {
		...
		return BigDecimal.class.isAssignableFrom(value.getClass())
				&& Float.class.isAssignableFrom(targetCls);
	}
	...
	public Float convert(Object value) {
		...
		return BigDecimal.class.cast(value).floatValue();
	}
}
